        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-magical-starlight/60 hover:text-magical-glowing-teal transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="text-magical-starlight/60 hover:text-magical-glowing-teal transition-colors">Terms of Service</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-magical-starlight/60 hover:text-magical-glowing-teal transition-colors">Support</a></li>
                <li><a href="#" className="text-magical-starlight/60 hover:text-magical-glowing-teal transition-colors">Blog</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-magical-glowing-teal/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              <a href="#" className="text-magical-starlight/60 hover:text-magical-glowing-teal transition-colors">
