	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'glow-border': 'linear-gradient(90deg, #9b87f5, #8265A7, #9b87f5)',
				...
				'wizardry-dark': 'linear-gradient(to bottom, #1A1F3C, #15122C)',
				'mystical-card': 'linear-gradient(to bottom, rgba(46, 58, 89, 0.7), rgba(26, 31, 60, 0.9))',
				'glowing-border': 'linear-gradient(90deg, #9b87f5, #44DDFF, #9b87f5)',
